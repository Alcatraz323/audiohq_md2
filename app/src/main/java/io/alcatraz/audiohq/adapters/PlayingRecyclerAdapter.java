...
public class PlayingRecyclerAdapter extends RecyclerView.Adapter<PlayingRecyclerAdapter.RecyclerHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull RecyclerHolder holder, int position) {
        ...
        holder.pin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AudioHQApplication application = (AudioHQApplication) activity.getApplication();
                if (element.isSticky()) {
                    application.getPlayingSystem().removeStickyApp(element.getPkg());
                    holder.pin.setImageResource(R.drawable.ic_pin_off);
    ...
    class RecyclerHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerHolder(@NonNull View itemView) {
            ...
            pin = itemView.findViewById(R.id.item_playing_pin);
        }
    }
